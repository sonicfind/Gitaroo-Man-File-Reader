...
struct ShapeVertex : Vertex
{
	float m_nextPosition[4] = { 0 };
	float m_nextNormal[3] = { 0 };
	float m_nextColor[4] = { 0 };
	float m_nextTexCoord[2] = { 0 };
};
